...
class EventsOnlyCartpoleWrapper(gym.Env):
    ...
    def step(self, action):
        ...
        # _with_pole_tilt() runs last so it copies-and-extends whatever keys
        # reward_shaping already added above, rather than the two features
        # clobbering each other's info entries.
